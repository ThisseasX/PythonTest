...
# instead of spaces " ", I am goint to use dots "."
...
# eveyrthing is the same, just in reverse order
...
# length = float(input("length of chars for the double arrow? > "))
# height = float(input("height of chars for the double arrow? > "))
